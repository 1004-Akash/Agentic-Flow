...
const Reports = () => {
  ...
  const handleDownload = (report) => {
      const content = `AGENTIC FLOW PIPELINE - IMMUTABLE COMPLIANCE LEDGER\n\n` +
                      `Report ID : ${report.id}\n` +
                      `Title     : ${report.name}\n` +
                      `Type      : ${report.type}\n` +
                      ...
                      `=== LOG DETAIL ===\n` +
                      `This is an autogenerated, cryptographically sealed ledger document reflecting the successful execution of the Agentic flow pipeline without human interruption.\n\n` + 
                      `All telemetry and deterministic paths are validated.`;
                         ...
                         <tr key={i} className="hover:bg-[#1E273A] transition-colors group">
                             ...
                             <td className="px-6 py-5 text-right">
                                 <div className="flex items-center justify-end gap-2">
                                     <button onClick={() => handleDownload(r)} className="p-2 hover:bg-[#252E46] rounded-lg text-slate-500 hover:text-white transition-all"><Download className="w-4 h-4" /></button>
